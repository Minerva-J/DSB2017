...
pbbpath = '/home/zhaojie/zhaojie/Lung/DSB_Code/DSB2017-master/training/detector/results/res18/TestBbox/'
ct_lungsegpath = './training/Data/ForTest/TestLungSeg/'
...
for i in range(len(imglist)):
    ...
    save_dir = os.path.join('./images',imglist[i].split('_')[0])
